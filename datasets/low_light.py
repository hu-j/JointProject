...
class LowLightDataset(data.Dataset):
    def __init__(self, root, images_split='images', targets_split='targets', color_tuning=False):
        self.root = root
        self.img_root = os.path.join(root, images_split)
        self.target_root = os.path.join(root, targets_split)
...
#     training_set = LowLightDataset('/home/xteam/hj/dataset/LOLForYolo/eval15',
#                                     'low',
#                                     'high')
